...
export const LeaderDetailFrom: FC = () => {
    ...
    return (
        <>
            <section className='m-auto my-10 w-[75%] gap-10 overflow-y-scroll main_scrollbar flex flex-col max-[1650px]:w-[90%] max-[1370px]:w-[95%] max-[1000px]:w-[94%] max-[1000px]:my-6 max-[400px]:w-[98%] max-[400px]:my-2' style={{ display: showbody ? "flex" : "none" }} >
                <>
                    <FromBg className="" >
